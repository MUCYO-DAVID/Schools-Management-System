      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-4">
        ...
        <div className="relative mb-6 py-6 rounded-[2rem] overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-2">
            ...
            <h1 className="text-2xl lg:text-4xl font-black tracking-tight text-slate-900 dark:text-white italic">
        ...
        <div className="min-h-[600px]">
          {activeTab === 'browse' && (
            <div className="space-y-6">
              ...
              <div className="max-w-3xl mx-auto relative group">
                ...
                <div className="relative flex items-center surface-card border border-slate-200 dark:border-white/10 rounded-[2rem] shadow-2xl p-0.5">
              ...
              {loading && schools.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pb-10">
                  {filteredSchools.map((school) => (
                    <div
                      key={school.id}
                      className="group surface-card rounded-3xl border border-slate-200 dark:border-white/5 overflow-hidden flex flex-col hover:border-purple-500/40 transition-all duration-500 shadow-xl"
                    >
                      <div className="relative h-32 w-full overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3 z-20">
                           <span className={`px-2 py-0.5 rounded-lg text-[8px] font-black uppercase tracking-widest backdrop-blur-md border border-slate-200 dark:border-white/10 ${school.type === "Public" ? "bg-emerald-500/20 text-emerald-300" : "bg-purple-500/20 text-purple-300"}`}>
                            {school.type}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto flex items-center gap-2">
                          <button
                            ...
                            className="flex-1 px-3 py-2 rounded-xl border border-slate-200 dark:border-white/5 text-[9px] font-black uppercase tracking-widest hover:bg-white/5 transition-all text-slate-400"
                          >
                            Info
                          </button>
                          <button
          ...
          {activeTab === 'applications' && (
            <div className="surface-card rounded-3xl border border-slate-200 dark:border-white/5 p-6 shadow-2xl">
              <div className="mb-6">
          ...
          {activeTab === 'grades' && (
            <div className="surface-card rounded-3xl border border-slate-200 dark:border-white/5 p-6 shadow-2xl">
              ...
              {loading ? (
                ...
                <div className="py-20 text-center bg-black/20 rounded-2xl border border-dashed border-slate-200 dark:border-white/5">
                ...
                <div className="space-y-6">
                  ...
                  {myReportCards.length > 0 && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {myReportCards.slice(0, 3).map((report) => (
                        <div key={report.id} className="bg-white/5 border border-slate-200 dark:border-white/5 rounded-2xl p-4">
                  ...
                  {/* Detailed Table */}
                  <div className="overflow-hidden bg-black/20 rounded-2xl border border-slate-200 dark:border-white/5">
          ...
          {activeTab === 'events' && (
            <div className="surface-card rounded-3xl border border-slate-200 dark:border-white/5 p-6 shadow-2xl">
              ...
              <div className="p-2 bg-white/5 rounded-2xl border border-slate-200 dark:border-white/5">
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {scholarships.map((s) => {
                    ...
                    return (
                      <div key={s.id} className="bg-white/5 border border-slate-200 dark:border-white/5 rounded-2xl p-4 hover:border-amber-500/20 transition-all group">
