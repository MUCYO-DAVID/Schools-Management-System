...
import { Award, BookOpen, MapPin, School as SchoolIcon, Star, Users } from "lucide-react"
            ...
            <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <aside className="w-full lg:w-80 lg:flex-shrink-0 order-2 lg:order-1">
                    <div className="lg:sticky lg:top-20">
                        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 mb-4">
                            <h3 className="text-lg font-bold text-gray-900 mb-2">Community Feedback</h3>
                            <p className="text-xs text-gray-600 mb-4">See what others are saying</p>
                        </div>
                        <div className="max-h-[600px] lg:max-h-[calc(100vh-12rem)] overflow-y-auto">
                            <SurveyCommentsFeed />
                        </div>
                    </div>
                </aside>
                ...
                <main className="flex-1 min-w-0 order-1 lg:order-2">
                    {!loadingMap && allSchools.length > 0 && (
                        <section className="py-8 bg-white rounded-lg mb-6 border border-gray-200 shadow-sm">
                            <div className="px-4 sm:px-6">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    {user?.role === "student" && (
                                        <Link
                                            href="/student"
                                            className="hidden sm:inline-flex items-center text-xs font-medium px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                                        >
                                            View All & Apply
                                        </Link>
                                    )}
                                ...
                                {!loadingMap && allSchools.length === 0 ? (
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                                        <p className="text-yellow-800 text-lg font-medium mb-2">No Schools Found</p>
