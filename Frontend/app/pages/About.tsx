  ...
  const team = [
    {
      ...
      bio: "Leading educational transformation in Rwanda with over 15 years of experience",
    },
    {
      name: "Marie Claire Mukamana",
      role: "Head of Technology",
      image: "/professional-woman-headshot.png",
      bio: "Expert in educational technology and digital transformation",
    },
    {
      name: "Emmanuel Nkurunziza",
      role: "School Relations Manager",
      image: "/professional-man-headshot.png",
      bio: "Dedicated to building strong relationships with schools nationwide",
    },
  ]
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 2020, the Rwanda School Bridge System (RSBS) was born from a vision to digitize and modernize
                  education management across the country.
                </p>
                <p>
      ...
      <section className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Meet the dedicated professionals leading our mission to transform education in Rwanda
          </p>
        </div>
